...
namespace AICUP.Mark2
{
    public class HeadquartersModule
    {
        ...
        public Action Execute(Dictionary<EntityType, List<Entity>> a1, PlayerView playerView, int money)
        {
            ...
            rearModule.DoAction(EntitiesSort, actions, playerView, money);
            defenceModule.DoAction(EntitiesSort, actions, playerView, money);
            attackModule.DoAction(EntitiesSort, actions, playerView, money);
