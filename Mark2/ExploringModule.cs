...
{
    public class ExploringModule : IModule
    {
        public Entity?[,] Map;
        ...
        public void DoAction(Dictionary<EntityType, List<Entity>> Entities, Dictionary<int, EntityAction> Actions, PlayerView playerView, int money)
        {
